...
public class MySQLUser implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String username) {
    com.finalproject.models.User user = userRepository.findByUsername(username);
    if (user == null) {
  ...
  public UserDetails Save( com.finalproject.models.User newUser) {
    newUser.setPassword(passwordEncoder.encode(newUser.getPassword()));
    com.finalproject.models.User savedUser = userRepository.save(newUser);

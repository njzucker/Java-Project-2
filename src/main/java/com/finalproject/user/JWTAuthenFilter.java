...
import static com.finalproject.user.AuthConstantses.*;
...
@Override
  public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws AuthenticationException {
    try {
      com.finalproject.models.User creds = new ObjectMapper()
        .readValue(req.getInputStream(), com.finalproject.models.User.class);
